...
class desafio_engenheiro:
    ...
    def create_source_dfs(self)-> None:
    ...
    def create_temp_views(self)->None:
        self.cliente.createOrReplaceTempView("cliente")
        self.contrato.createOrReplaceTempView("contrato")
        self.transacao.createOrReplaceTempView("transacao")
    ...
    def create_transaction_table(self)->DataFrame:
        ...
        transacao_data = [(1, 1, 3000.00, 6.99), 
                          (2, 2, 4500.00, 15.00), 
                          (3, 1, 57989.00, 1.45), 
                          (4, 4, 1.00, None), 
                          (5, 4, 35.00, None)]
